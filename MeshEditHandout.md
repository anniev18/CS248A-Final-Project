...
The [Cardinal3D Wiki](https://stanford-cs248.github.io/Cardinal3D/) is the primary source of information/documentation about this assignment. On that page you will find all the details about how to use the starter code, what you need to implement, and tips/guidelines for implementing it. 
